                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body pt-3 pb-3">
                            <div class="d-flex align-items-center">
                                <div class="mr-3">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($this->session->userdata('nama')); ?>&background=random&size=50" class="img-circle elevation-1" alt="User Image">
                                </div>
                                <div>
                                    <h5 class="mb-0 text-primary font-weight-bold"><?php echo $this->session->userdata('nama'); ?></h5>
                                    <div class="text-muted text-sm">
                                        <i class="fas fa-id-card mr-1"></i> ID: 
                                        <?php echo $this->session->userdata('nidk') ?: $this->session->userdata('npm') ?: 'ADMIN'; ?> 
                                        | <span class="badge badge-secondary"><?php echo strtoupper($role); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
