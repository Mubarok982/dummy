            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('operator/acc_judul'); ?>">Persetujuan Dosen Pembimbing</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4 card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url('operator/update_dospem'); ?>" method="post" class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo base_url('operator/acc_judul'); ?>" class="btn btn-secondary">
