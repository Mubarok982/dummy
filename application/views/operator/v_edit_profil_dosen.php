<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Profil Dosen</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('operator/data_dosen') ?>">Data Dosen</a></li>
                ...
                <div class="col-md-4">
                    <div class="card card-primary card-outline shadow-sm">
                        <div class="card-body box-profile">
                            ...
                            <p class="text-muted text-center"><?= $user['nidk'] ?></p>
                ...
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <?= form_open_multipart('operator/save_profil_dosen/' . $user['id']) ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>NIDK</strong></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $user['nidk'] ?>" disabled>
                                        <small class="text-muted form-text">NIDK tidak dapat diubah melalui halaman ini</small>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label"><strong>Program Studi</strong></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?= $user['prodi_dsn'] ?>" disabled>
                                        <small class="text-muted form-text">Program Studi tidak dapat diubah melalui halaman ini</small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-9 offset-sm-3">
                                        <a href="<?= base_url('operator/data_dosen') ?>" class="btn btn-secondary">
