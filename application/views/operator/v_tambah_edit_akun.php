...
<script>
    function toggleRoleFields(role) {
        ...
        // Hapus attribute 'required' dari input yang tersembunyi agar form submit lancar
    ...
    function disableInputsIn(container) {
        ...
        inputs.forEach(function(input) {
            // Kita tidak disable input, hanya menghapus required (opsional, tergantung validasi server)
            // Tapi sebaiknya biarkan saja, validasi utama di controller.
        });
    }

    function enableInputsIn(container) {
        // Placeholder function jika butuh logika enable
    }
